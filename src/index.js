...
function Board() {
  ...
  // (Array(9).fill(null)) = This will create a the 9 boxes that will go into our tik tak to. The fill(null) will make sure all of the show blank on the screen
  ...
  const onIncreaseClickHandler = (index) => {
    // if the clickCount is less than 9 (true) and the array [index] is the position within the array. If there is nothing display null. ===(confirmed value). LEARN ABOUT ARRAY IN DETAILS!!!
  ...
  return (
    <div>
      ...
      className is the .css file and they are being imported from there.
       ...
       We entered the <div className="board-row"> because we are creating three lines of three squares. if we do not use it than there will be issue in the styling.
